...
for /R "T:\10 - Contracts\10.02 - Variations\Dayworks Sheets\JKC Approved DWS for Filing to folders\2. JKC Approved DWS (UNZIPPED)\2017\" %%G in (*FI-*) do (

call :process2 %%~nG

)

for /R "T:\10 - Contracts\10.02 - Variations\Dayworks Sheets\JKC Approved DWS for Filing to folders\2. JKC Approved DWS (UNZIPPED)\2017\" %%G in (*SI-*) do (
